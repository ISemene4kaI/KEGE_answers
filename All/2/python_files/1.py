'''
Миша заполнял таблицу истинности функции (x or (not y)) and (not (y==z)) and w  но успел заполнить лишь фрагмент из трёх различных её строк, даже не указав,

Таблица находится в файле table1.md
